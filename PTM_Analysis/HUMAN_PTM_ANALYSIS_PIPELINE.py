...
def add_PTM_and_PLAAC_annotations(papa_results_file, plaac_results_file, mod_dict):
    ...
    output.write('Accession Number\tGene\tMax PAPA Score\tHighest-scoring Window Sequence(s)\tHighest-scoring Window(s) Indices\tOverlapping PLAAC PrLD?\tPLAAC PrLD Indices\n')
