...
def add_PTM_and_PLAAC_annotations(papa_results_file, plaac_results_file, mod_dict):
    ...
    #name should be the name of the .TSV file that was output from running the version of of PAPA that merges overlapping windows
    name, ext = papa_results_file.split('.')
...
def barchart_lnOR_PTMs(mod_info):
    ...
    plt.xticks(fontname='Arial', rotation=90)
